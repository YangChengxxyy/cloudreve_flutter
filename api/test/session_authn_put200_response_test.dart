...
// tests for SessionAuthnPut200Response
void main() {
  final instance = SessionAuthnPut200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(SessionAuthnPut200Response, () {
    // SessionAuthnPut200ResponseData data
