...
// tests for VasGiftcodeCodeGet200Response
void main() {
  final instance = VasGiftcodeCodeGet200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(VasGiftcodeCodeGet200Response, () {
    // VasGiftcodeCodeGet200ResponseData data
