...
// tests for UserSearchGet200Response
void main() {
  final instance = UserSearchGet200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(UserSearchGet200Response, () {
    ...
    // BuiltList<UserSearchGet200ResponseDataInner> data
