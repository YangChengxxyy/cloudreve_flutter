...
// tests for UserSettingPoliciesGet200Response
void main() {
  final instance = UserSettingPoliciesGet200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(UserSettingPoliciesGet200Response, () {
