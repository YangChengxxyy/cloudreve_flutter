...
// tests for UserInfoUserIdGet200Response
void main() {
  final instance = UserInfoUserIdGet200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(UserInfoUserIdGet200Response, () {
    // UserInfoUserIdGet200ResponseData data
