...
// tests for FileSourcePut200Response
void main() {
  final instance = FileSourcePut200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(FileSourcePut200Response, () {
    ...
    // BuiltList<FileSourcePut200ResponseDataInner> data
