...
// tests for VasPaymentStatusIdTradeNoGet200Response
void main() {
  final instance = VasPaymentStatusIdTradeNoGet200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(VasPaymentStatusIdTradeNoGet200Response, () {
    // Payment data
