...
// tests for FileViewerSessionPut200Response
void main() {
  final instance = FileViewerSessionPut200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(FileViewerSessionPut200Response, () {
    // FileViewerSessionPut200ResponseData data
