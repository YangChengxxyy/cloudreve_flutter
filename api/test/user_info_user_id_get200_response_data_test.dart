...
// tests for UserInfoUserIdGet200ResponseData
void main() {
  final instance = UserInfoUserIdGet200ResponseDataBuilder();
  // TODO add properties to the builder and call build()

  group(UserInfoUserIdGet200ResponseData, () {
    // ID of the user.
    // String id
    ...
    // UserInfoUserIdGet200ResponseDataGroup group
