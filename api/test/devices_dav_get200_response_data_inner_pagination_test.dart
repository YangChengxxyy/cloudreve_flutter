...
// tests for DevicesDavGet200ResponseDataInnerPagination
void main() {
  final instance = DevicesDavGet200ResponseDataInnerPaginationBuilder();
  // TODO add properties to the builder and call build()

  group(DevicesDavGet200ResponseDataInnerPagination, () {
