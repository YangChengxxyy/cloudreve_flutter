...
// tests for GroupListGet200Response
void main() {
  final instance = GroupListGet200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(GroupListGet200Response, () {
    ...
    // BuiltList<GroupListGet200ResponseDataInner> data
