...
// tests for UserSharesUserIdGet200Response
void main() {
  final instance = UserSharesUserIdGet200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(UserSharesUserIdGet200Response, () {
    // ListShareResponse data
