...
// tests for UserCreditChangesGet200ResponseDataPagination
void main() {
  final instance = UserCreditChangesGet200ResponseDataPaginationBuilder();
  // TODO add properties to the builder and call build()

  group(UserCreditChangesGet200ResponseDataPagination, () {
