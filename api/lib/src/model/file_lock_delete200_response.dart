...
part 'file_lock_delete200_response.g.dart';

/// FileLockDelete200Response
///
/// Properties:
...
@BuiltValue()
abstract class FileLockDelete200Response implements Built<FileLockDelete200Response, FileLockDelete200ResponseBuilder> {
  ...
  FileLockDelete200Response._();

  factory FileLockDelete200Response([void updates(FileLockDelete200ResponseBuilder b)]) = _$FileLockDelete200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(FileLockDelete200ResponseBuilder b) => b
      ..code = 0;

  @BuiltValueSerializer(custom: true)
  static Serializer<FileLockDelete200Response> get serializer => _$FileLockDelete200ResponseSerializer();
}

class _$FileLockDelete200ResponseSerializer implements PrimitiveSerializer<FileLockDelete200Response> {
  @override
  final Iterable<Type> types = const [FileLockDelete200Response, _$FileLockDelete200Response];

  @override
  final String wireName = r'FileLockDelete200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    FileLockDelete200Response object, {
  ...
  void _deserializeProperties(
    ...
    required FileLockDelete200ResponseBuilder result,
  ...
  @override
  FileLockDelete200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = FileLockDelete200ResponseBuilder();
