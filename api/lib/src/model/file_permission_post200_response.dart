...
part 'file_permission_post200_response.g.dart';

/// FilePermissionPost200Response
///
/// Properties:
...
@BuiltValue()
abstract class FilePermissionPost200Response implements Built<FilePermissionPost200Response, FilePermissionPost200ResponseBuilder> {
  ...
  FilePermissionPost200Response._();

  factory FilePermissionPost200Response([void updates(FilePermissionPost200ResponseBuilder b)]) = _$FilePermissionPost200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(FilePermissionPost200ResponseBuilder b) => b
      ..code = 0;

  @BuiltValueSerializer(custom: true)
  static Serializer<FilePermissionPost200Response> get serializer => _$FilePermissionPost200ResponseSerializer();
}

class _$FilePermissionPost200ResponseSerializer implements PrimitiveSerializer<FilePermissionPost200Response> {
  @override
  final Iterable<Type> types = const [FilePermissionPost200Response, _$FilePermissionPost200Response];

  @override
  final String wireName = r'FilePermissionPost200Response';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    FilePermissionPost200Response object, {
  ...
  void _deserializeProperties(
    ...
    required FilePermissionPost200ResponseBuilder result,
  ...
  @override
  FilePermissionPost200Response deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = FilePermissionPost200ResponseBuilder();
