...
import 'package:cloudreve_api_client/src/model/folder_summary.dart';
import 'package:cloudreve_api_client/src/model/extended_info.dart';
...
/// * [metadata] - Key-value  map of all metadata. Some special metadata might affect the file's behavior, please refer to [Metadata](https://docs.cloudreve.org/en/api/metadata) for details.
...
abstract class FileResponse implements Built<FileResponse, FileResponseBuilder> {
  ...
  @BuiltValueField(wireName: r'extended_info')
  ExtendedInfo? get extendedInfo;

  @BuiltValueField(wireName: r'folder_summary')
  FolderSummary? get folderSummary;
...
class _$FileResponseSerializer implements PrimitiveSerializer<FileResponse> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.extendedInfo != null) {
      yield r'extended_info';
      yield serializers.serialize(
        object.extendedInfo,
        specifiedType: const FullType.nullable(ExtendedInfo),
      );
    }
    if (object.folderSummary != null) {
      yield r'folder_summary';
      yield serializers.serialize(
        object.folderSummary,
        specifiedType: const FullType.nullable(FolderSummary),
      );
    }
  }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'primary_entity':
          ...
          break;
        case r'extended_info':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(ExtendedInfo),
          ) as ExtendedInfo?;
          if (valueDes == null) continue;
          result.extendedInfo.replace(valueDes);
          break;
        case r'folder_summary':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(FolderSummary),
          ) as FolderSummary?;
          if (valueDes == null) continue;
          result.folderSummary.replace(valueDes);
          break;
        default:
          unhandled.add(key);
          unhandled.add(value);
...
class FileResponseTypeEnum extends EnumClass {

  /// Type of this file.
  @BuiltValueEnumConst(wireNumber: 0)
  static const FileResponseTypeEnum number0 = _$fileResponseTypeEnum_number0;
  /// Type of this file.
  @BuiltValueEnumConst(wireNumber: 1)
  static const FileResponseTypeEnum number1 = _$fileResponseTypeEnum_number1;

  static Serializer<FileResponseTypeEnum> get serializer => _$fileResponseTypeEnumSerializer;

  const FileResponseTypeEnum._(String name): super(name);

  static BuiltSet<FileResponseTypeEnum> get values => _$fileResponseTypeEnumValues;
  static FileResponseTypeEnum valueOf(String name) => _$fileResponseTypeEnumValueOf(name);
}
