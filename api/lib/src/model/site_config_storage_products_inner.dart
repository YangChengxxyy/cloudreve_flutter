...
@BuiltValue()
abstract class SiteConfigStorageProductsInner implements Built<SiteConfigStorageProductsInner, SiteConfigStorageProductsInnerBuilder> {
  /// Any Of [StorageProduct]
  AnyOf get anyOf;

  SiteConfigStorageProductsInner._();

  factory SiteConfigStorageProductsInner([void updates(SiteConfigStorageProductsInnerBuilder b)]) = _$SiteConfigStorageProductsInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SiteConfigStorageProductsInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SiteConfigStorageProductsInner> get serializer => _$SiteConfigStorageProductsInnerSerializer();
}

class _$SiteConfigStorageProductsInnerSerializer implements PrimitiveSerializer<SiteConfigStorageProductsInner> {
  @override
  final Iterable<Type> types = const [SiteConfigStorageProductsInner, _$SiteConfigStorageProductsInner];
  ...
  SiteConfigStorageProductsInner deserialize(
    ...
    Object? anyOfDataSrc;
    final targetType = const FullType(AnyOf, [FullType.nullable(StorageProduct), ]);
