...
part 'file_create_post200_response_data.g.dart';
...
abstract class FileCreatePost200ResponseData implements Built<FileCreatePost200ResponseData, FileCreatePost200ResponseDataBuilder> {
  ...
  FileCreatePost200ResponseData._();

  factory FileCreatePost200ResponseData([void updates(FileCreatePost200ResponseDataBuilder b)]) = _$FileCreatePost200ResponseData;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(FileCreatePost200ResponseDataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<FileCreatePost200ResponseData> get serializer => _$FileCreatePost200ResponseDataSerializer();
}

class _$FileCreatePost200ResponseDataSerializer implements PrimitiveSerializer<FileCreatePost200ResponseData> {
  @override
  final Iterable<Type> types = const [FileCreatePost200ResponseData, _$FileCreatePost200ResponseData];

  @override
  final String wireName = r'FileCreatePost200ResponseData';
  ...
  void _deserializeProperties(
    ...
    required FileCreatePost200ResponseDataBuilder result,
      ...
      switch (key) {
        case r'type':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(FileCreatePost200ResponseDataTypeEnum),
          ) as FileCreatePost200ResponseDataTypeEnum;
  ...
  @override
  FileCreatePost200ResponseData deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = FileCreatePost200ResponseDataBuilder();
...
class FileCreatePost200ResponseDataTypeEnum extends EnumClass {

  /// Type of this file.
  @BuiltValueEnumConst(wireNumber: 0)
  static const FileCreatePost200ResponseDataTypeEnum number0 = _$fileCreatePost200ResponseDataTypeEnum_number0;
  /// Type of this file.
  @BuiltValueEnumConst(wireNumber: 1)
  static const FileCreatePost200ResponseDataTypeEnum number1 = _$fileCreatePost200ResponseDataTypeEnum_number1;

  static Serializer<FileCreatePost200ResponseDataTypeEnum> get serializer => _$fileCreatePost200ResponseDataTypeEnumSerializer;

  const FileCreatePost200ResponseDataTypeEnum._(String name): super(name);

  static BuiltSet<FileCreatePost200ResponseDataTypeEnum> get values => _$fileCreatePost200ResponseDataTypeEnumValues;
  static FileCreatePost200ResponseDataTypeEnum valueOf(String name) => _$fileCreatePost200ResponseDataTypeEnumValueOf(name);
}
