...
import 'package:cloudreve_api_client/src/model/file_source_id_delete200_response.dart';
...
class FileDirectLinkApi {
  ...
  const FileDirectLinkApi(this._dio, this._serializers);
  ...
  Future<Response<FileSourceIdDelete200Response>> fileSourceidDelete({ 
    ...
    FileSourceIdDelete200Response? _responseData;
    ...
    return Response<FileSourceIdDelete200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
