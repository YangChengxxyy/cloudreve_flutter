...
import 'package:cloudreve_api_client/src/model/share_id_delete200_response.dart';
...
class ShareApi {
  ...
  Future<Response<ShareIdDelete200Response>> shareIdDelete({
    ...
    ShareIdDelete200Response? _responseData;
    ...
    return Response<ShareIdDelete200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
