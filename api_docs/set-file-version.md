...
paths:
  /file/version/current:
    post:
      ...
      deprecated: false
      description: Set the current version of the file.
      tags:
        - File/Version
        - 'Auth: JWT Optional'
      parameters:
              ...
              properties:
                uri:
                  ...
                  description: >-
                    ...
                    file.
                  examples:
                    - cloudreve://my/copy.md
                version:
                  type: string
                  examples:
                    - 9ewQi2
                  description: >-
                    ID of the version to set as "current version". The version
                    blob must be linked to current file. List of available
                    versions can be retrieved via [Get file
                    info](./get-file-info-306769225e0)
              x-apifox-orders:
                - uri
                - version
              required:
          ...
          content:
            application/json:
              schema:
                type: object
                x-apifox-refs:
                  01JXCB863BYRF22SPHS0EKMD7K: &ref_0
                    $ref: '#/components/schemas/Response'
                    x-apifox-overrides:
                      aggregated_error: null
                      data: null
                x-apifox-orders:
                  - 01JXCB863BYRF22SPHS0EKMD7K
                properties:
                  code:
                    type: integer
                    description: |-
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/6271409/apis/api-306782378-run
components:
  schemas:
    Response:
      type: object
