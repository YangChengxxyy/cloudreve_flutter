...
info:
  ...
  version: 1.0.0
paths:
  /vas/payment/status/{id}/{trade_no}:
    get:
      ...
      parameters:
        ...
        - name: trade_no
          ...
          required: true
          example: '20250612141601003370839825'
          schema:
            type: string
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                type: object
                x-apifox-refs:
                  01JXHCQJE8C6ATAJJ824RFVBBN: &ref_1
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/6271409/apis/api-307895484-run
components:
  schemas:
    Response:
      type: object
