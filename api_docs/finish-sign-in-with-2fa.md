...
paths:
  /session/token/2fa:
    post:
      summary: Finish sign-in with 2FA
      deprecated: false
      description: >-
        After [Password
        Login](https://cloudrevev4.apifox.cn/password-sign-in-289490586e0.md),
        if 2FA is required, this API is used to finish 2FA challenge and obtain
        a pair of token.
      tags:
        - Session/Token
        - 'Auth: None'
            ...
            schema:
              ...
              properties:
                ...
                session_id:
                  type: string
                  format: uuid
                  description: 2FA login session ID.
              x-apifox-orders:
                - opt
                - session_id
              required:
          ...
          content:
            application/json:
              schema:
                type: object
                x-apifox-refs:
                  01JSRG26E3S2HFARH9VR6JCH82: &ref_1
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/6271409/apis/api-289502780-run
components:
  schemas:
    Response:
      type: object
