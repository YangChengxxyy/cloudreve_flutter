...
paths:
  /devices/dav:
    put:
          ...
          content:
            application/json:
              schema:
                type: object
                x-apifox-refs:
                  01JXKWZQRTP7GVYN86ZPZBPRD7: &ref_1
              ...
              example:
                ...
                data:
                  id: YnCp
                  created_at: '2025-06-13T13:43:14.421686+08:00'
                  name: new account
                  uri: cloudreve://my/0
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/6271409/apis/api-308388845-run
components:
  schemas:
