...
paths:
  /share:
    put:
          ...
          content:
            application/json:
              schema:
                type: object
                x-apifox-refs:
                  01JXCEZ2DZPNKCT7Q1FVKT0NDX: &ref_2
                    $ref: '#/components/schemas/Response'
                    x-apifox-overrides:
                      data: &ref_0
                        type: string
                        description: >-
                          URL of the share link. The formt is
              ...
              examples:
                '1':
                  summary: Private share
                  value:
                    code: 0
                    data: http://localhost:5173/s/g2guA/gcqzfaze
                    msg: ''
                '2':
                  summary: Public share
                  value:
                    code: 0
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/6271409/apis/api-306853462-run
components:
  schemas:
    ShareCreateService:
      type: object
