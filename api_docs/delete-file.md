...
paths:
  /file:
    delete:
          ...
          application/json:
            schema:
              ...
              properties:
                ...
                unlink:
                  type: boolean
                  description: >-
                    Whether to keep physical files while recycling file blobs.
                    This option only works if the user group have "Advanced
                    delete option` enabed.
                  nullable: true
                skip_soft_delete:
                  type: boolean
                  description: >-
                    Whether to skip trash bin, directly delete those files. This
                    option only works file file owner or administrators.
                  nullable: true
              x-apifox-orders:
                - uris
                - unlink
            ...
            examples:
              '1':
                ...
                summary: Delete without trash bin
              '2':
                value:
                  uris:
                    - cloudreve://my/newfile.docx
                ...
                summary: Move files to trash bin
              '3':
                value:
                  uris:
                    - cloudreve://trash/2e24002d-bbae-4345-8b92-844cc1f5e2a2
                  unlink: false
                  skip_soft_delete: true
                summary: Delete files in trash bin
      responses:
        '200':
          description: ''
          content:
            application/json:
              schema:
                type: object
                x-apifox-refs:
                  01JXBZR6PS39R70E1QZYNNB4Y2: &ref_0
                    $ref: '#/components/schemas/Response'
                    x-apifox-overrides:
                      data: null
                x-apifox-orders:
                  - 01JXBZR6PS39R70E1QZYNNB4Y2
                properties:
                  code:
                    type: integer
                    description: |-
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/6271409/apis/api-306637209-run
components:
  schemas:
    Response:
      type: object
