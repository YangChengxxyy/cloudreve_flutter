...
// tests for UserCapacityGet200Response
void main() {
  final instance = UserCapacityGet200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(UserCapacityGet200Response, () {
    // UserCapacityGet200ResponseData data
