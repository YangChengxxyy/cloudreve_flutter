...
// tests for UserSearchGet200ResponseDataInner
void main() {
  final instance = UserSearchGet200ResponseDataInnerBuilder();
  // TODO add properties to the builder and call build()

  group(UserSearchGet200ResponseDataInner, () {
    // ID of the user.
    // String id
    ...
    // UserSearchGet200ResponseDataInnerGroup group
