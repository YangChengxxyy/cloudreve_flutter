...
// tests for UserCreditChangesGet200Response
void main() {
  final instance = UserCreditChangesGet200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(UserCreditChangesGet200Response, () {
    // UserCreditChangesGet200ResponseData data
