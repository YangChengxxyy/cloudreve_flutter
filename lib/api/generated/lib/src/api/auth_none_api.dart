...
import 'package:cloudreve_api_client/src/model/session_authn_post200_response.dart';
import 'package:cloudreve_api_client/src/model/session_authn_post_request.dart';
import 'package:cloudreve_api_client/src/model/session_authn_put200_response.dart';
import 'package:cloudreve_api_client/src/model/session_openid_post200_response.dart';
import 'package:cloudreve_api_client/src/model/session_openid_post_request.dart';
import 'package:cloudreve_api_client/src/model/session_prepare_get200_response.dart';
import 'package:cloudreve_api_client/src/model/session_token2fa_post200_response.dart';
import 'package:cloudreve_api_client/src/model/session_token2fa_post_request.dart';
import 'package:cloudreve_api_client/src/model/session_token_delete200_response.dart';
import 'package:cloudreve_api_client/src/model/session_token_delete_request.dart';
import 'package:cloudreve_api_client/src/model/session_token_post200_response.dart';
import 'package:cloudreve_api_client/src/model/session_token_post_request.dart';
import 'package:cloudreve_api_client/src/model/session_token_refresh_post200_response.dart';
import 'package:cloudreve_api_client/src/model/site_captcha_get200_response.dart';
import 'package:cloudreve_api_client/src/model/site_ping_get200_response.dart';
import 'package:cloudreve_api_client/src/model/user_post200_response.dart';
import 'package:cloudreve_api_client/src/model/user_post_request.dart';
import 'package:cloudreve_api_client/src/model/user_reset_post200_response.dart';
import 'package:cloudreve_api_client/src/model/user_reset_post_request.dart';
import 'package:cloudreve_api_client/src/model/user_reset_user_id_patch200_response.dart';
import 'package:cloudreve_api_client/src/model/user_reset_user_id_patch_request.dart';
...
class AuthNoneApi {
  ...
  const AuthNoneApi(this._dio, this._serializers);
  ...
  /// * [key] - Key of the complete upload URL.
  ...
  Future<Response<CallbackCosSessionIdKeyGet200Response>> callbackCosSessionIdKeyGet({ 
    ...
    CallbackCosSessionIdKeyGet200Response? _responseData;
    ...
    return Response<CallbackCosSessionIdKeyGet200Response>(
      data: _responseData,
  ...
  Future<Response<SessionAuthnPost200Response>> sessionAuthnPost({ 
    ...
    SessionAuthnPost200Response? _responseData;
    ...
    return Response<SessionAuthnPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SessionAuthnPut200Response>> sessionAuthnPut({ 
    ...
    SessionAuthnPut200Response? _responseData;
    ...
    return Response<SessionAuthnPut200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SessionOpenidPost200Response>> sessionOpenidPost({ 
    ...
    SessionOpenidPost200Response? _responseData;
    ...
    return Response<SessionOpenidPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SessionPrepareGet200Response>> sessionPrepareGet({ 
    ...
    SessionPrepareGet200Response? _responseData;
    ...
    return Response<SessionPrepareGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SessionToken2faPost200Response>> sessionToken2faPost({ 
    ...
    final _path = r'/session/token/2fa';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SessionToken2faPost200Response? _responseData;
    ...
    return Response<SessionToken2faPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SessionTokenDelete200Response>> sessionTokenDelete({ 
    ...
    SessionTokenDelete200Response? _responseData;
    ...
    return Response<SessionTokenDelete200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SessionTokenPost200Response>> sessionTokenPost({ 
    ...
    SessionTokenPost200Response? _responseData;
    ...
    return Response<SessionTokenPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SessionTokenRefreshPost200Response>> sessionTokenRefreshPost({ 
    ...
    final _path = r'/session/token/refresh';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SessionTokenRefreshPost200Response? _responseData;
    ...
    return Response<SessionTokenRefreshPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SiteCaptchaGet200Response>> siteCaptchaGet({ 
    ...
    SiteCaptchaGet200Response? _responseData;
    ...
    return Response<SiteCaptchaGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SitePingGet200Response>> sitePingGet({ 
    ...
    SitePingGet200Response? _responseData;
    ...
    return Response<SitePingGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [nocache] - Force `Cache-Control` header to be `nocache` to disable cache.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<UserPost200Response>> userPost({ 
    ...
    UserPost200Response? _responseData;
    ...
    return Response<UserPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UserResetPost200Response>> userResetPost({ 
    ...
    UserResetPost200Response? _responseData;
    ...
    return Response<UserResetPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UserResetUserIdPatch200Response>> userResetUserIdPatch({ 
    ...
    UserResetUserIdPatch200Response? _responseData;
    ...
    return Response<UserResetUserIdPatch200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UserSharesUserIdGet200Response>> userSharesUserIdGet({ 
    ...
    UserSharesUserIdGet200Response? _responseData;
    ...
    return Response<UserSharesUserIdGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
